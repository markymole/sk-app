<div class="bg-gray-900 py-10 lg:py-8">
    <div class="2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 px-4 max-w-6xl">
        <div class="flex flex-col lg:flex-row-reverse justify-between items-center  gap-8">
            <div class="w-full lg:w-6/12 flex flex-col justify-center">
                <h1 class="text-2xl lg:text-4xl font-bold leading-9 text-white pb-4">About Us</h1>
                <div class="bg-yellow-400 h-0.5 lg:h-1 w-24 mb-4"></div>
                <p class="max-w-2xl mb-6 font-light lg:mb-8 md:text-lg lg:text-xl text-gray-300">Hi, Welcome to Sk WebbyApp<br>We're into connecting the Sangguniang Kabataan Officials and the Youths through this user friendly system. They can stay updated on what are the plans of the SK officials for the community and what are the event's that need the participations of the youths. Sk WebbyApp is easier to access and can communicate to the both user, for SK officials and the people of the barangay especially youths.</p>
            </div>
            <div class="w-full lg:w-6/12">
                <img class="w-64 lg:w-78" src="./assets/illustrations/chatting.png" alt="A group of People" />
            </div>
        </div>

        <div class="flex flex-col justify-between pt-20">
            <div class="w-full flex flex-col justify-center">
                <h1 class="text-2xl lg:text-4xl font-bold leading-9 text-white pb-4">Our Mission</h1>
                <div class="bg-yellow-400 h-1 w-24 mb-4"></div>
