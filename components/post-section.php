...
?>
    <div class="rounded-xl border p-5 shadow-md bg-white w-full text-gray-700 mt-6 text-center w-full lg:w-1/2 lg:mx-auto">
        <img src="assets/illustrations/no_record.jpg" class="w-1/2 mx-auto" alt="">
        <h5>This post is unavailable or does not exist.</h5>
    </div>
<?php } ?>